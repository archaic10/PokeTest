...
var PokeController = /** @class */ (function () {
    function PokeController() {
    }
    PokeController.prototype.attack = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, attack, defense;
            return __generator(this, function (_b) {
                _a = request.body, attack = _a.attack, defense = _a.defense;
                ...
                response.json({ attack: attack, defense: defense });
                return [2 /*return*/];
            });
        });
    };
